...
if(foodName == "Ramoli Roti")	return foodPrice = 33 *quantity;
	
if(foodName == "Kulcha" ) return foodPrice = 36 *quantity;
	
if(foodName == "Ceylon Parotta" )	return foodPrice = 38 *quantity;
	
if(foodName == "Coin Parotta")	return foodPrice =31 *quantity;
	
if(foodName == "Dry Chapati") return foodPrice =31 *quantity;
	
if(foodName == "Empire Mix Parotta" )	return foodPrice =196 *quantity;
	
if(foodName == "Egg Parotta")	return foodPrice =84 *quantity;

if(foodName == "Ghee Chapati")	return foodPrice =34 *quantity;

if(foodName == "Malbar Parotta" )return foodPrice =32 *quantity;
	
if(foodName == "Boiled egg") return foodPrice =42 *quantity;
	
if(foodName == "Egg Burji" )	return foodPrice =84 *quantity;
	
if(foodName == "Egg Masala")	return foodPrice =121 *quantity;
	
if(foodName == "Dosa Chicken" )	return foodPrice =153 *quantity;
	
if(foodName == "Mutton Keema Dosa" )	return foodPrice =173 *quantity;
	
if(foodName == "Onion Dosa") return foodPrice =46 *quantity;
	
if(foodName == "Chicken Shawarma" )	return foodPrice =93 *quantity;

if(foodName == "Pappad" )	return foodPrice =21 *quantity;
	
if(foodName == "Raitha")	return foodPrice =67 *quantity;
	
if(foodName ==  "Lady Lychee")	return foodPrice =121 *quantity;
	
if(foodName == "Tender Cocinut Pudding") return foodPrice =73 *quantity;
	
if(foodName == "Lychee Malba")	return foodPrice =176 *quantity;	
